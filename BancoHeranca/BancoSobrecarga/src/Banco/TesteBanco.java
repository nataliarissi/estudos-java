...
public class TesteBanco {
    ...
    System.out.println(contaBanco.toString());
        ...
        ContaBasica contaBasica = new ContaBasica( "Luk807", 0, 0, 8801, 6200, "Itachi", 8012, 0);
    System.out.println(contaBasica.toString());  

        System.out.println("Conta Padrão");    
        ContaPadrao contaPadrao = new ContaPadrao( "Itc001", 988, 0, 9078, 2200, "Sasuke", 10);
    System.out.println(contaPadrao.toString());

        System.out.println("Conta Premium");    
        ContaPremium contaPremium = new ContaPremium( "Lin701", 2800, 0, 8701, 1070, "Sakura", 50);
